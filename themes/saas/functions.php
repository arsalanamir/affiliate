...
function theme_activate(){
	...
	$default = [
		...
		"testimonial" => [
				...
				"items" => [
					[
						"text" => "With InstaUrl.me I can turn my single profile link into endless possibilities. It allows me to not only create a list of great resources my audience will love, but create additional revenue opportunities for sponsored links on my profile! I can increase my fee for shoutouts by offering a sponsored link on my InstaUrl.me bio page.",
						"author" => "Influencer ",
						"logo" => "https://image.freepik.com/free-icon/apple-logo_318-40184.jpg",
						"title" => "Social Media Influencer Quote"
					],
					[
...
/*                            <img src="<?php echo $this->config["url"] ?>/content/<?php echo $this->config["logo"] ?>"*/
