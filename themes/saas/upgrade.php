            ...
            <div class="price-table">
              <div class="table-inner text-center">    
                ...
                <ul class="feature-list">
                  ...
                  <li><i class="glyphicon glyphicon-ok"></i> <span><strong><?php echo $plan["credits_per_click"] == "0" ? e("0") : $plan["credits_per_click"] ?> </strong> <?php echo e("Credits per click") ?></span></li>
                  <li><i class="glyphicon glyphicon-ok"></i> <span><strong><?php echo $plan["cookie_expires_in_days"] == "0" ? e("Unlimited") : $plan["cookie_expires_in_days"] ?> </strong> <?php echo e("days between credits from each user.") ?></span></li>
